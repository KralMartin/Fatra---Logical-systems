...
namespace ContextMenu_Mono.Menu
{
    public class MenuPanel : Controler
    {
        ...
        public void Changed(Rectangle parentBounds)
        {
            ...
            Point myOffset = CalculateOffset(this.Settings.Halign, this.Settings.Valign, this.Settings.Margin, new Point(this.relativeBounds.Width, this.relativeBounds.Height), parentSize);
